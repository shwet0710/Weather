    ...
    Http.onreadystatechange = () => {
        if (Http.readyState === 4 && Http.status === 200) {
            ...
            if (weatherCondition == "clear") {
                img.setAttribute('src', 'image/clear.svg');
            }
            else if (weatherCondition == "cloud") {
                img.setAttribute('src', 'image/cloud.svg');
            }
            else if (weatherCondition == "haze") {
                img.setAttribute('src', 'image/haze.svg');
            }
            else if (weatherCondition == "rain") {
                img.setAttribute('src', 'image/rain.svg');
            }
            else if (weatherCondition == "snow") {
                img.setAttribute('src', 'image/snow.svg');
            }
            else {
                img.setAttribute('src', 'image/storm.svg');
            }
